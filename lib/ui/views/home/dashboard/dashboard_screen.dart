...
import 'package:hibiki_point/providers/auth_provider.dart';
import 'package:hibiki_point/providers/campaign_provider.dart';
import 'package:hibiki_point/data/response/campaign_response.dart';
import 'package:hibiki_point/data/response/log_activity_with_include_response.dart';
import 'package:hibiki_point/res/colors.dart';
import 'package:hibiki_point/ui/views/campaign/campaign_detail_screen.dart';
import 'package:hibiki_point/ui/views/campaign/campaign_screen.dart';
import 'package:hibiki_point/ui/views/notification/notification_screen.dart';
import 'package:hibiki_point/ui/views/report/report_screen.dart';
import 'package:hibiki_point/ui/views/task/task_screen.dart';
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Column(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Expanded(child: _menuIcon('Campaign', const Icon(Icons.favorite))),
                Expanded(child: _menuIcon('Report', const Icon(Icons.numbers))),
            ...
            Column(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Expanded(child: _menuIcon('Task', const Icon(Icons.numbers))),
                Expanded(child: _menuIcon('Help', const Icon(Icons.numbers))),
